            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RouteNumber = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "8839, 10"),
                    RouteName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Stop1 = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    VehicleNumber = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "8998, 5"),
                    VehicleName = table.Column<string>(type: "nvarchar(30)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EmployeeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1006, 50"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employees_Routes_RouteNumber",
