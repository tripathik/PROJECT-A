...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TransportManagementSystem.Models.Employee", b =>
                {
                    b.HasOne("TransportManagementSystem.Models.Route", "Routes")
                        .WithMany()
                        .HasForeignKey("RouteNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TransportManagementSystem.Models.Vehicle", "Vehicles")
                        .WithOne("Employee")
                        .HasForeignKey("TransportManagementSystem.Models.Employee", "VehicleNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
